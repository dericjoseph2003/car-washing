...
// Fetch all bookings
$query = "SELECT * FROM booking ORDER BY booking_date DESC, booking_time DESC";
...
<body>
    ...
    <script>
        ...
        function updateStatus(bookingId, newStatus) {
            fetch('bookings.php', {  // Changed from update_status.php to bookings.php since the handler is already there
                method: 'POST',
                headers: {
